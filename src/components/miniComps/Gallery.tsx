...
const Gallery: FunctionComponent<GalleryProps> = () => {
    return (<div id="myWork">
        <div className="card">
            <img src="/images/NailsImage.png" alt="Nails" title="Nails Art" />
        </div>
        <div className="card">
            <img src="/images/fingers(4).jpeg" alt="Nails Art 4" title="Nails Art 4" />
        </div>
        <div className="card">
            <img src="/images/fingers(6).jpeg" alt="Nails Art 6" title="Nails Art 6" />
        </div>
        <div className="card">
